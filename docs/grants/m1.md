...
><font color="orange"> To facilitate the testing of unmortgage operation below, we recommend performing multiple mortgage operations.</font>
...
> <font color="orange"> Optional step, if unmortgage is performed here, the subsequent steps need to be carried out, and  
> the mortgage operation mentioned earlier needs to be repeated.</font>
...
### 1.4. Cluster uploads the SGX public key, proving that the entire control panel is operating in a secure and trusted environment.
...
### 1.5. As user to submit a test tee program
